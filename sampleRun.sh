...
#newtCmd="$NEWTEXE --Np $Np --Nt $Nt1 --Nn 10 --scenario $scenario --elasticCollisionActivation --backgroundSpecieActivation"
#saveCmd="$EXE --Np $Np --Nt $Nt1 --dt $dt --scenario $scenario --elasticCollisionActivation --backgroundSpecieActivation"
