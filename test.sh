...
python3 ./chebSolver.py --Np 150 --Nt 100 --dt 0.03125 --scenario 7 --V0 100 --VDC 0.0 --t0 0.0 \
--tscheme BE --elasticCollisionActivation --backgroundSpecieActivation \
--outfile restart.npy --savedata fullsoln.npy --verbose
