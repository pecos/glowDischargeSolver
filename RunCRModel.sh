...
FLAGS="--V0 150 --VDC 0.0 --gam 0.2 --scenario $scenario --EinsteinForm --backgroundSpecieActivation"
# --EinsteinForm --elasticCollisionActivation --backgroundSpecieActivation

baseCmd="$EXE $FLAGS --Np $Np --Nt $Nt --dt $dt --tscheme BE"
newtCmd="$NEWTEXE $FLAGS --Np $Np --Nt $Nt1 --Nn 20 --tscheme CN --alpha0 0.01 --increaseFac 1.2"
