...
# newtFile="${baseFile}T1750.npy"
# saveFile="CR_Np${Np}_fullsoln_T1750.npy"
# echo "Saving one period...${saveFile}"
# $saveCmd --V0 100 --VDC 0.0 --rtol 1e-8 --restart $newtFile --savedata $saveFile --outfile discard.npy >> $screenOut


newtFile="${baseFile}T2250.npy"
saveFile="CR_Np${Np}_fullsoln_T2250.npy"
echo "Saving one period...${saveFile}"
$saveCmd --V0 100 --VDC 0.0 --rtol 1e-8 --restart $newtFile --savedata $saveFile --outfile discard.npy >> $screenOut

newtFile="${baseFile}T2500.npy"
saveFile="CR_Np${Np}_fullsoln_T2500.npy"
echo "Saving one period...${saveFile}"
$saveCmd --V0 100 --VDC 0.0 --rtol 1e-8 --restart $newtFile --savedata $saveFile --outfile discard.npy >> $screenOut

newtFile="${baseFile}T2750.npy"
saveFile="CR_Np${Np}_fullsoln_T2750.npy"
echo "Saving one period...${saveFile}"
$saveCmd --V0 100 --VDC 0.0 --rtol 1e-8 --restart $newtFile --savedata $saveFile --outfile discard.npy >> $screenOut
